...
|-----------------|---------------------|-----------|-------|
| > 200% (healthy) | 20 bps (0.20%) | 0.40% | Vault сильно обеспечен |
| 150–200% (normal) | 40 bps (0.40%) | 0.80% | Стандартная работа |
| 100–150% (elevated) | 60 bps (0.60%) | 1.20% | Стресс — комиссии растут |
...
При здоровом vault (>200%, roundtrip fee = 0.40%):

| Сценарий | TVL | Дневной объём | Fee APY | Funding APY | **Общий APY** |
|----------|-----|---------------|---------|-------------|---------------|
| Консервативный | $500K | $100K | 29.20% | 36.50% | **65.70%** |
| Умеренный | $1M | $250K | 36.50% | 36.50% | **73.00%** |
| Агрессивный | $2M | $500K | 36.50% | 36.50% | **73.00%** |

При стрессовом vault (150–200%, roundtrip fee = 0.80%):

| Сценарий | TVL | Дневной объём | Fee APY | Funding APY | **Общий APY** |
|----------|-----|---------------|---------|-------------|---------------|
| Консервативный | $500K | $100K | 58.40% | 36.50% | **94.90%** |
| Умеренный | $1M | $250K | 73.00% | 36.50% | **109.50%** |
| Агрессивный | $2M | $500K | 73.00% | 36.50% | **109.50%** |
