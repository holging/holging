...
|-------|--------|----------------|
| > 200% | 🟢 Здоровый | Минимальная комиссия (20 bps), LP может свободно выводить |
| 150–200% | 🟡 Нормальный | Стандартная комиссия (40 bps) |
| 110–150% | 🟠 Повышенный | Высокая комиссия (60 bps), LP вывод доступен |
...
```
Комиссия: 40 bps per side = 80 bps roundtrip

Fee revenue/день  = $100,000 × 0.004 = $400
Fee revenue/год   = $400 × 365 = $146,000
...
Fee revenue/день  = $300,000 × 0.008 = $2,400
Fee revenue/год   = $2,400 × 365 = $876,000
...
После крэша (SOL −50%):
  ...
  Комиссия переключается на 60 bps (×15 множитель)
...
|-------------|-------------|----------|----------------|---------|----------------|
| +100% (×2) | 500%+ | 20 bps | 65%+ | Нет | ✅ Свободно |
| +50% (×1.5) | 333%+ | 20 bps | 60%+ | Нет | ✅ Свободно |
| +25% (×1.25) | 250%+ | 20 bps | 55%+ | Нет | ✅ Свободно |
| ±0% | Initial | 20–40 bps | 55–73% | Нет | ✅ Свободно |
| −25% (×0.75) | ~150% | 40 bps | 70–95% | Минимальный | ✅ Свободно |
| −33% (×0.67) | ~120% | 60 bps | 80–110% | Умеренный | ✅ Свободно |
| −40% (×0.60) | ~105% | 60 bps | 85–115% | Высокий | ⚠️ Ограничено |
