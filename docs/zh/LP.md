...
|------------|------------------|-----------|----------|
| > 200%（健康） | 2 bps (0.02%) | 0.04% | Vault 超额抵押 |
| 150–200%（正常） | 20 bps (0.20%) | 0.40% | 标准运行 |
| 100–150%（升高） | 40 bps (0.40%) | 0.80% | 压力状态 — 手续费上升 |
...
在健康 vault（>200%，roundtrip fee = 0.04%）下：

| 场景 | TVL | 日交易量 | Fee APY | Funding APY | **总 APY** |
|------|-----|----------|---------|-------------|------------|
| 保守 | $100K | $10K | 1.46% | 36.50% | **37.96%** |
| 适中 | $500K | $100K | 2.92% | 36.50% | **39.42%** |
| 激进 | $2M | $500K | 3.65% | 36.50% | **40.15%** |

在压力 vault（150–200%，roundtrip fee = 0.40%）下：

| 场景 | TVL | 日交易量 | Fee APY | Funding APY | **总 APY** |
|------|-----|----------|---------|-------------|------------|
| 保守 | $100K | $10K | 14.60% | 36.50% | **51.10%** |
| 适中 | $500K | $100K | 29.20% | 36.50% | **65.70%** |
