...
| 比率 | 状态 | 发生什么 |
|-------|--------|----------------|
| > 200% | 🟢 健康 | 最低手续费（2 bps），LP 可自由提取 |
| 150–200% | 🟡 正常 | 标准手续费（20 bps） |
| 110–150% | 🟠 升高 | 较高手续费（40 bps），LP 可提取 |
...
```
手续费：2 bps 单边 = 4 bps 往返

手续费收益/天    = $100,000 × 0.0004 = $40
手续费收益/年    = $40 × 365 = $14,600
...
手续费收益/天    = $300,000 × 0.004 = $1,200
手续费收益/年    = $1,200 × 365 = $438,000
...
LP 损益：
  手续费：$500K × 0.0004 × 365 / $500K = 14.6% APY
  Funding：30.59% APY
...
|-------------|-------------|----------|----------------|---------|----------------|
| +100%（×2） | 500%+ | 2 bps | 45%+ | 无 | ✅ 自由 |
| +50%（×1.5） | 333%+ | 2 bps | 40%+ | 无 | ✅ 自由 |
| +25%（×1.25） | 250%+ | 2 bps | 38%+ | 无 | ✅ 自由 |
| ±0% | 初始值 | 2–20 bps | 33–40% | 无 | ✅ 自由 |
| −25%（×0.75） | ~150% | 20 bps | 50–65% | 极低 | ✅ 自由 |
| −33%（×0.67） | ~120% | 40 bps | 60–80% | 中等 | ✅ 自由 |
| −40%（×0.60） | ~105% | 40 bps | 65–85% | 高 | ⚠️ 受限 |
...
| 动态手续费乘数 | `{>200%: ×0.5, 150–200%: ×5, 100–150%: ×10, <100%: ×20}` |
| Holging 盈亏平衡 | `SOL 变动 > ±4%`（0.08% 往返手续费） |
